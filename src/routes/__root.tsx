...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium CCTV, IP cameras, biometric access, and networking for homes, offices, industries and societies across India." },
      { name: "author", content: "Vigilant Technologies" },
      { property: "og:title", content: "Vigilant Technologies — Premium Smart Security, Pune" },
      { property: "og:description", content: "Premium CCTV, IP cameras, biometric access, and networking for homes, offices, industries and societies across India." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Vigilant Technologies — Premium Smart Security, Pune" },
      { name: "twitter:description", content: "Premium CCTV, IP cameras, biometric access, and networking for homes, offices, industries and societies across India." },
    ],
    links: [
