...
import { METRICS, PROCESS, BRAND } from "@/lib/site-data";
...
import officeInterior from "@/assets/generated/office_interior_1784034640882.png";
import engineeringTeam from "@/assets/generated/engineering_team_1784034629814.png";
  ...
  return (
    <>
      <section className="relative min-h-[80svh] flex items-center justify-center bg-foreground overflow-hidden">
        <img src={officeExterior} alt="Vigilant Office" className="absolute inset-0 h-full w-full object-cover opacity-30 mix-blend-luminosity scale-105 animate-hero-zoom" />
      ...
      <section className="container-x grid lg:grid-cols-2 gap-16 py-32">
        <div className="relative aspect-square overflow-hidden rounded-[2rem] border border-border/50 bg-surface group">
          <img src={officeInterior} alt="Vigilant team at work" loading="lazy" className="absolute inset-0 h-full w-full object-cover transition-transform duration-[1200ms] group-hover:scale-105" />
      ...
      <Section className="bg-surface border-y border-border/60">
        <div className="grid md:grid-cols-2 gap-12">
           <div className="surface-card p-10 sm:p-16 flex flex-col gap-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">{BRAND.vision}</p>
           </div>
           <div className="surface-card p-10 sm:p-16 flex flex-col gap-6">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">{BRAND.mission}</p>
           </div>
        </div>
      </Section>
      ...
      <Section>
        ...
        <div className="mt-16 grid sm:grid-cols-3 gap-6">
           {[
              ...
              { icon: HeartHandshake, t: "Customer Obsession", d: "From 48-hour survey turnarounds to 1-hour critical responses, our clients always come first." },
           ...
           {[1, 2, 3, 4].map((t) => (
              <div key={t} className="group">
                 <div className="aspect-[3/4] rounded-3xl overflow-hidden bg-background border border-border/60 relative">
                    <img src={engineeringTeam} alt="Team member" className="w-full h-full object-cover grayscale opacity-20 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-[1200ms] object-top" />
